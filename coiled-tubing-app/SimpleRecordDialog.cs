...
{
    public sealed class SimpleRecordDialog : ContentDialog
    {
        ...
        public SimpleRecordDialog()
        {
            ...
            this.Loaded += (s, e) => _recordNameTextBox.Focus(FocusState.Programmatic);
        }
        ...
        private void OnSaveButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SimpleRecordDialog OnSaveButtonClick error: {ex.Message}");
                args.Cancel = true;
            }
        }
    }
